{ enableAdult ? false, game, linuxWrapperScript, lib, steamcmd, steam-run, writeScript, writeScriptBin, gameFiles, steamUserInfo, realGameLocation, lndir, steamcmdLogin, ... }:
